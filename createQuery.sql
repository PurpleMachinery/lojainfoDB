...
CREATE TABLE tbHardware(
	pk_idHardware INT PRIMARY KEY IDENTITY(1,1),
...
CREATE TABLE tbVendas(
	pk_idVenda INT PRIMARY KEY IDENTITY(1,1),
	fk_idCliente INT NOT NULL FOREIGN KEY REFERENCES tbClientes(pk_idCliente),
	data DATE NOT NULL,
...
CREATE TABLE tbItensVenda(
	pk_idItem INT PRIMARY KEY IDENTITY (1,1),
	fk_idVenda INT NOT NULL FOREIGN KEY REFERENCES tbVendas(pk_idVenda),
	fk_idHardware INT NOT NULL FOREIGN KEY REFERENCES tbHardware(pk_idHardware),
	qtde INT NOT NULL,
